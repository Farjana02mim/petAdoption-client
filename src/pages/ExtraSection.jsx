        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-xl hover:scale-105 transition-transform">
              ...
              <h3 className="text-lg font-semibold text-black mb-1">Cozy Dog Sweater</h3>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-xl hover:scale-105 transition-transform">
              ...
              <h3 className="text-lg text-black font-semibold mb-1">Warm Cat Hoodie</h3>
            ...
            <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-xl hover:scale-105 transition-transform">
              ...
              <h3 className="text-lg text-black font-semibold mb-1">Furry Boots for Dogs</h3>
